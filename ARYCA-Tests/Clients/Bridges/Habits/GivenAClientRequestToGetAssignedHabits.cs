...
{
	[TestFixture]
	public sealed class GivenAClientRequestToGetAssignedHabits
	{
		...
		public async Task Setup()
		{
			...
			_subject = await _habitsBridge.GetAllHabitsAssigned(user.Username);
		}

		[Test]
		public void ThenTheHabitsAreNotNull()
		{
